...
SQL_DELETA_JOGO = 'delete from app where id = %s'
SQL_JOGO_POR_ID = 'SELECT id, nome, categoria, console from app where id = %s'
SQL_USUARIO_POR_ID = 'SELECT id, nome, senha from usuario where id = %s'
SQL_ATUALIZA_JOGO = 'UPDATE app SET nome=%s, categoria=%s, console=%s where id = %s'
SQL_BUSCA_JOGOS = 'SELECT id, nome, categoria, console from app'
SQL_CRIA_JOGO = 'INSERT into app (nome, categoria, console) values (%s, %s, %s)'
